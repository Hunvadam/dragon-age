# Dragon Age RPG (Homebrew) — Minimal System (v13)
...
- Flat placeholder fields:
  ...
  - Notes textbox
- Token bars linked: **Bar 1 → Health**, **Bar 2 → Stamina**.

## Install
1. Unzip into `Data/systems/dragon-age`.
2. Restart Foundry (v13.350).
3. Create/select a world using this system.
4. Make an NPC actor and drag it onto a scene to place a token.
# dragon-age
